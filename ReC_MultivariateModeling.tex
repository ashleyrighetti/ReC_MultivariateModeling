...
\textbf{If you are viewing this document, you should know that this is a book-in-progress. Early drafts are released for the purpose teaching my classes and gaining formative feedback from a host of stakeholders. The document was last updated on 26 Apr 2021}
...
CAPTURING RESULTS FOR WRITING IT UP: Data screening suggested that 50 individuals opened the survey link.
...
CAPTURING RESULTS FOR WRITING IT UP: Data screening suggested that 50 individuals opened the survey link. Of those, 43, granted consent and proceeded into the survey items.
...
CAPTURING RESULTS FOR WRITING IT UP: Data screening suggested that 50 individuals opened the survey link. Of those, 43, granted consent and proceeded into the survey items. A further inclusion criteria was that the course was taught in the U.S; 38 met this criteria.
...
Data screening suggested that 50 individuals opened the survey link. Of those, 43 granted consent and proceeded to the survey items. A further inclusion criteria was that the course was taught in the U.S; 38 met this criteria.
...
There is about1 hour and 15 minutes of lecture. If you work through the materials with me it would be plan for an additional hour and a half.
...
\item
  ...
  \item
    specify a model with indirect effects,
  \item
    identify and interpret B weights, \emph{p} values, and \emph{CIs} for total, direct, and indirect effects, - calculate the total effects of X and M on Y,
  \item
    identify the proportion of variance accounted for in predicting M and Y.
  \end{itemize}
\item
...
\includegraphics{ReC_MultivariateModeling_files/figure-latex/MOD a path plot-1.pdf}
...
\includegraphics{ReC_MultivariateModeling_files/figure-latex/MOD a path plot-2.pdf}
...
\includegraphics{ReC_MultivariateModeling_files/figure-latex/MOD c path plot-1.pdf}
...
\includegraphics{ReC_MultivariateModeling_files/figure-latex/MOD c path plot-2.pdf}
...
\includegraphics{ReC_MultivariateModeling_files/figure-latex/semPlot of simple med in the modmed-1.pdf}
...
\includegraphics{ReC_MultivariateModeling_files/figure-latex/semPlot of the modmed-1.pdf}
